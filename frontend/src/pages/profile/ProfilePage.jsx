						...
						<>
							<div className='flex gap-10 px-4 py-2 items-center'>
								...
								<div className='flex flex-col'>
									...
									<span className='text-sm text-base-content/60'>posts</span>
								</div>
							</div>
							{/* COVER IMG */}
							<div className='relative group/cover'>
								...
								{isMyProfile && (
									<div
										className='absolute top-2 right-2 rounded-full p-2 bg-base-300/80 cursor-pointer opacity-0 group-hover/cover:opacity-100 transition duration-200'
							...
							<div className='flex w-full border-b border-base-300 mt-4'>
								...
								<div
									className='flex justify-center flex-1 p-3 text-base-content/60 hover:bg-base-200 transition duration-300 relative cursor-pointer'
